...
{{endpoint-description}} <- wklej opisy metod api z business-logic-plan.md, z których będzie korzystał widok
</interface_description>

5. Interface implementation:
<interface_implementation>
{{interface-implementation}} <- zamień na referencję do implementacji, z których będzie korzystał widok (np. @generations.ts, @flashcards.ts)
</interface_implementation>
