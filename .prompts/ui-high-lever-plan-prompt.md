...
1. Dokładnie przeanalizuj PRD, projekt interfejsów i notatki z sesji.
2. Wyodrębnij i wypisz kluczowe wymagania z PRD.
3. Zidentyfikuj i wymień główne metody interfejsów i ich cele.
4. Utworzenie listy wszystkich niezbędnych widoków na podstawie PRD, interfejsów i notatek z sesji.
...
10. Upewnij się, że architektura interfejsu użytkownika jest zgodna z zaplanowanymi interfejsami.
...
- Nazwa widoku
- Ścieżka widoku (route w aplikacji)
- Główny cel
