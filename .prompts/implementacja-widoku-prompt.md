...
<implementation_plan>
@.ai/auth-view-view-implementation-plan.md
</implementation_plan>

Teraz przejrzyj zasady implementacji:

<implementation_rules>
.cursor\rules\frontend-react-guidelines.mdc
...
2. Integracja API:
   - Zidentyfikuj wszystkie API/interfejsy.
   - Wdróż niezbędne wywołania API/interfejsów.
   - Obsłuż możliwe rezultaty i odpowiednio aktualizacji stan komponentów.
